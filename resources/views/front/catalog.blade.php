...
@section('content')
    ...
    <section class="catalog">
        <div class="container">
            <div class="section__nav">
                <nav>
                    @foreach ($categoreis as $category)
                        <a href="#{{ $category->name_uz }}" class="nav-link current">{{ $category->name_ru }}</a>
                    @endforeach
                </nav>
            ...
            @foreach ($categoreis as $category)
                <div class="catalog__item" id="{{ $category->name_uz }}">
                            ...
                            <a href="#">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M13.5087 2.53174H7.41007C5.52265 2.53174 3.89557 4.06166 3.89557 5.94999V15.7702C3.89557 17.7649 5.41632 19.3553 7.41007 19.3553H14.7333C16.6217 19.3553 18.1516 17.6595 18.1516 15.7702V7.36807L13.5087 2.53174Z"
                                        stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                                        d="M13.2679 2.521V5.18758C13.2679 6.48925 14.3211 7.54525 15.6219 7.548C16.8291 7.55075 18.0639 7.55166 18.1473 7.54616"
                                        stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M13.0937 14.2613H8.14642" stroke="white" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M11.2223 9.72176H8.14597" stroke="white" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
